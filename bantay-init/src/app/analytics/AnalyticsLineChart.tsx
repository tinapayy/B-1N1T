// src/components/analytics/AnalyticsLineChart.tsx
import {
    ChartContainer,
    ChartTooltip,
    ChartTooltipContent,
  ...
  export default function AnalyticsLineChart({ data, timeframe, setTimeframe }: any) {
    const config = {
      heatIndex: { label: "Heat Index", color: "var(--orange-primary)" },
          ...
          <ChartContainer config={config} className="h-[300px] flex-grow aspect-auto">
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={data} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
                ...
                <Line type="monotone" dataKey="heatIndex" stroke="var(--color-heatIndex)" strokeWidth={2} dot={false} />
              </LineChart>
            </ResponsiveContainer>
          </ChartContainer>
