// src/components/analytics/HeatAlertTable.tsx
import {
    Table,
    TableBody,
    TableCell,
            ...
            <Table>
              <TableHeader>
                <TableRow className="hover:bg-transparent">
                  ...
                  <TableHead className="w-1/3 text-center py-2">Heat Index</TableHead>
                  <TableHead className="w-1/3 text-right py-2">Date & Time</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                {alerts.map((alert: any) => (
                  <TableRow key={alert.id} className="hover:bg-muted/50">
                    ...
                    <TableCell className="py-2 text-center">{alert.heatIndex}</TableCell>
